...
func (m *MockTalker) SayHello(workd string) string {
	ret := m.ctrl.Call(m, "SayHello", workd)
	ret0, _ := ret[0].(string)
	return ret0
}

// SayHello indicates an expected call of SayHello
func (mr *MockTalkerMockRecorder) SayHello(workd interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHello", reflect.TypeOf((*MockTalker)(nil).SayHello), workd)
}
